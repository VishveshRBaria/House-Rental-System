...
class SeeHouseAdapterOwner(private val context: Context, private val houseModelArrayList: ArrayList<HouseModel>) :
    RecyclerView.Adapter<SeeHouseAdapterOwner.ViewHolder>() {
