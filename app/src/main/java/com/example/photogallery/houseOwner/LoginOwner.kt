...
import com.example.photogallery.houseOwner.DashboardOwner
import com.example.photogallery.houseOwner.RegisterOwner
import com.example.photogallery.houseOwner.ResetPasswordOwner
...
class LoginOwner : AppCompatActivity() {
...
//    private lateinit var progressDialog: ProgressDialog
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv_forgotPassword.setOnClickListener {
            startActivity(Intent(this@LoginOwner, ResetPasswordOwner::class.java))
        }
...
//        progressDialog = ProgressDialog(this)
        ...
        tv_registerBtn.setOnClickListener {
            startActivity(Intent(this@LoginOwner, RegisterOwner::class.java))
        }
    }
...
//                            progressDialog.dismiss()
                            ...
                            Toast.makeText(this@LoginOwner, "Login Successful", Toast.LENGTH_SHORT).show()
                        } else {
//                            progressDialog.dismiss()
                            Toast.makeText(this@LoginOwner, "Login Failed", Toast.LENGTH_SHORT).show()
                        }
                    }
            }
        }
    ...
    private fun sendUserToMainActivity() {
        val intent = Intent(this@LoginOwner, DashboardOwner::class.java)
